...
namespace MultiCrafting { 
	public class UIHorizontalScrollbar : UIElement { //Thank you Javid
		...
		public UIHorizontalScrollbar()
		{
			...
			this._texture = ModContent.Request<Texture2D>("MultiCrafting/Textures/ScrollbarHorizontal"); ;
            this._innerTexture = ModContent.Request<Texture2D>("MultiCrafting/Textures/ScrollbarInnerHorizontal");
            this.PaddingLeft = 5f;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			this.DrawBar(spriteBatch, _texture.Value, dimensions.ToRectangle(), Color.White);
			this.DrawBar(spriteBatch, _innerTexture.Value, handleRectangle, Color.White * ((this._isDragging || this._isHoveringOverHandle) ? 1f : 0.85f));
		}
